      ...
      <div className="bg-land-warm rounded-[32px] p-8 md:p-12 lg:p-16 border border-land-cream/50 shadow-[0_8px_32px_rgba(44,57,48,0.05)]">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <h2 className="font-land-heading font-bold text-land-ink text-3xl md:text-5xl leading-tight mb-6" style={{ textWrap: "balance" }}>
              Langkah kecil,<br/>dampak nyata.
            </h2>
            <p className="text-land-muted text-base md:text-lg leading-relaxed mb-10">
              Setiap kilogram limbah yang tidak dibakar atau dibuang sembarangan adalah napas baru bagi bumi. Hitung kontribusi positif Anda menggunakan kalkulator sirkular kami.
            </p>

            <div className="bg-white rounded-[24px] p-6 shadow-sm border border-land-cream/40">
              <div className="flex justify-between items-end mb-4">
                <span className="text-xs font-bold text-land-muted uppercase tracking-wider">Volume Limbah</span>
                <span className="font-land-heading text-2xl font-bold text-[#009A44]">{volume} kg</span>
              </div>
              ...
              <div className="relative pt-2 pb-6">
                <input 
                  ...
                  style={{ background: `linear-gradient(to right, #009A44 ${((volume - 10) / 990) * 100}%, #E8E0D5 ${((volume - 10) / 990) * 100}%)` }}
          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-5">
            ...
            <div className="bg-white rounded-[24px] p-6 shadow-[0_8px_24px_rgba(44,57,48,0.03)] border border-land-cream/30 flex items-center justify-between group hover:-translate-y-1 transition-transform">
              <div>
                <div className="text-[11px] font-bold text-land-muted uppercase tracking-widest mb-1">Setara Penanaman</div>
                <div className="text-3xl font-land-heading font-bold text-land-ink">{treesPlanted} <span className="text-lg text-land-muted font-normal">Pohon</span></div>
              </div>
            ...
            <div className="bg-white rounded-[24px] p-6 shadow-[0_8px_24px_rgba(44,57,48,0.03)] border border-[#009A44]/20 flex items-center justify-between group hover:-translate-y-1 transition-transform relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="text-[11px] font-bold text-[#009A44] uppercase tracking-widest mb-1">Potensi Nilai Ekonomi</div>
                <div className="text-3xl font-land-heading font-bold text-land-ink">Rp {valueMin}k <span className="text-lg text-land-muted font-normal">- {valueMax}k</span></div>
              </div>

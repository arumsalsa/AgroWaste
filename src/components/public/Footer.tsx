        ...
        <div className="flex flex-col lg:flex-row justify-between gap-16 lg:gap-24 mb-20">
          ...
          <div className="lg:w-5/12 flex flex-col">
            <Link href="/" className="inline-flex items-center gap-2.5 mb-8 group">
              <img src="/LOGO.png" alt="AgroWaste Logo" className="h-10 w-auto object-contain transition-transform duration-300 group-hover:scale-105" />
              <span className="text-2xl font-land-heading font-bold text-white tracking-tight">AgroWaste</span>
            </Link>
            <h2 className="text-3xl md:text-5xl font-land-heading font-bold text-white leading-tight mb-8" style={{ textWrap: "balance" }}>
              Masa depan sirkular dimulai dari tanah.
            </h2>
            <div className="flex flex-col sm:flex-row gap-4 mt-auto">
              <Link href="/register" className="inline-flex items-center justify-center gap-2 px-6 py-4 rounded-full bg-[#009A44] text-white font-bold hover:bg-[#008139] transition-all hover:-translate-y-1">
                Bergabung Sekarang
          ...
          <div className="lg:w-6/12 grid grid-cols-2 sm:grid-cols-3 gap-10">
            ...
            <div className="flex flex-col gap-6">
              ...
              <Link href="/marketplace" className="text-[#A0AAB2] hover:text-white transition-colors">Beli Organik</Link>
              <Link href="/seller" className="text-[#A0AAB2] hover:text-white transition-colors">Jual Limbah</Link>
              <Link href="/courier" className="text-[#A0AAB2] hover:text-white transition-colors">Mitra Logistik</Link>
            </div>

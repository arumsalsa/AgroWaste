    ...
    <header className="bg-admin-surfacewhite h-16 border-b border-admin-hairline px-4 sm:px-8 flex items-center justify-between sticky top-0 z-20 gap-4">
      <div className="flex items-center gap-3 flex-1 min-w-0">
        ...
        <div className="relative flex-1 max-w-md hidden sm:block">
          ...
          <input
            type="search"
            placeholder="Cari pengguna, transaksi, atau log sistem..."
      ...
      <div className="flex items-center gap-3 shrink-0">
        ...
        <div className="relative hidden md:block">
          <select className="block py-1.5 pl-3 pr-8 text-xs bg-admin-warmbg border border-admin-hairline rounded-full focus:outline-none focus:ring-1 focus:ring-admin-primary appearance-none cursor-pointer text-admin-textsecondary font-medium">
            <option>Semua Kategori</option>
            <option>Peternak (Penjual)</option>
            <option>Pembeli</option>
            <option>Kurir Logistik</option>
          </select>
        ...
        <button
          ...
          className="relative p-2 text-admin-textsecondary hover:text-admin-textprimary hover:bg-admin-warmbg rounded-full transition-colors"
        >
          <span className="absolute top-1 right-1 w-2 h-2 rounded-full bg-admin-semred" aria-hidden="true" />
          <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">

      ...
      <div className="max-w-7xl mx-auto px-6 pt-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
          <div className="flex items-center gap-4">
            <Link
              href="/pesanan"
              className="w-12 h-12 rounded-full bg-white border border-[#E8E0D5] flex items-center justify-center text-land-ink hover:border-land-accent hover:text-land-accent transition-colors shadow-sm"
            >
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            <div className="bg-white p-2 rounded-[40px] shadow-[0_8px_32px_rgba(44,57,48,0.05)] border border-[#E8E0D5] overflow-hidden">
              <div className="w-full h-[400px] md:h-[500px] rounded-[32px] overflow-hidden relative bg-[#E8E0D5] shadow-inner">
                <MapTracking
                  startCoords={[112.6575, -7.8892]} // Store (Singosari)
                  endCoords={[112.60966, -7.9453]} // Home (Dinoyo)
                  courierCoords={[112.632, -7.921]} // Courier (Pak Agus)
              ...
              <div className="flex items-center gap-5 relative z-10">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <span className="px-3 py-1 bg-white/10 rounded-full text-xs font-bold text-emerald-400 tracking-widest uppercase border border-white/10">
                      B 1234 ABC
                    </span>
            ...
            <div className="bg-white border border-[#E8E0D5] rounded-[32px] p-8 shadow-[0_8px_32px_rgba(44,57,48,0.04)] sticky top-24">
              ...
              <div className="relative pl-7 space-y-10">
                ...
                <div className="relative">
                  ...
                  <p className="text-xs text-land-muted mt-1">
                    24 Okt 2026, 11:30 WIB
                    <br />
                    Peternak sedang mengemas pupuk organik Anda.
                  </p>
                </div>
                ...
                <div className="relative">
                  ...
                  <p className="text-xs text-land-muted mt-1 leading-relaxed">
                    24 Okt 2026, 14:45 WIB
                    <br />
                    Pak Agus telah menjemput pesanan Anda dan sedang dalam
                    perjalanan menuju lokasi pengiriman.
                  </p>
                </div>
                ...
                <div className="relative opacity-40">
                  ...
                  <p className="text-xs text-land-muted mt-1">
                    Estimasi tiba hari ini sebelum pukul 18:00 WIB
                  </p>
                </div>
              </div>
            </div>

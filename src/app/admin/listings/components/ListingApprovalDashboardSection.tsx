  ...
  return (
    <div className="bg-admin-surfacewhite border border-admin-hairline rounded-2xl overflow-hidden">
      ...
      <div className="p-6 border-b border-admin-hairline flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div
          className="flex bg-admin-warmbg p-1.5 rounded-xl gap-1 max-w-full overflow-x-auto w-full sm:w-auto"
          role="tablist"
          aria-label="Category filter"
        >
          {(["All Pending", "Limbah Padat", "Limbah Cair"] as FilterKey[]).map(
            (f) => (
              <button
                key={f}
                type="button"
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-semibold text-admin-textprimary group-hover:text-admin-primary transition-colors">
                          {listing.title}
                        </div>
                  ...
                  {/* Seller */}
                  <td className="px-6 py-4">
                    <div className="font-semibold text-admin-textprimary">
                      {listing.seller}
                    </div>
                    <span
                      className={`text-[10px] font-bold px-1.5 py-0.5 rounded ${sellerBadgeClass(listing.sellerBadge)}`}
                    >
                      {listing.sellerBadge}
                    </span>
                  </td>
                  ...
                  {/* Date */}
                  <td className="px-6 py-4 text-sm text-admin-textsecondary font-tabular">
                    {listing.date}
                  </td>

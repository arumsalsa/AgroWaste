        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          {activeTab === 'personal' && (
            <form onSubmit={handleSavePersonal} className="space-y-6 animate-fade-in">
              ...
              <div className="bg-admin-surfacewhite border border-admin-hairline p-6 rounded-2xl">
                <h3 className="text-lg font-bold text-admin-textprimary mb-6">Informasi Dasar</h3>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="block text-xs font-bold text-admin-textsecondary mb-1">ID Karyawan</label>
                      <input type="text" value="AGW-ADM-2026-004" disabled className="w-full px-4 py-2.5 bg-admin-hairline/50 border border-admin-hairline rounded-xl text-sm font-bold text-admin-textsecondary font-tabular cursor-not-allowed" />
                    </div>
                  </div>
                  <div>
                    <label className="block text-xs font-bold text-admin-textsecondary mb-1">Deskripsi Tugas Khusus</label>
                    <textarea rows={3} value={profileBio} onChange={(e) => setProfileBio(e.target.value)} className="w-full px-4 py-2.5 bg-admin-warmbg border border-admin-hairline rounded-xl text-sm text-admin-textprimary focus:outline-none focus:ring-1 focus:ring-admin-primary"></textarea>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input type="text" defaultValue="+62 812-3456-7890" className="w-full px-4 py-2.5 bg-admin-warmbg border border-admin-hairline rounded-xl text-sm text-admin-textprimary font-tabular focus:outline-none focus:ring-1 focus:ring-admin-primary" />
                    </div>
                  </div>
                  <div>
                    <label className="block text-xs font-bold text-admin-textsecondary mb-1">Lokasi Tugas Utama</label>
                    <select className="w-full px-4 py-2.5 bg-admin-warmbg border border-admin-hairline rounded-xl text-sm text-admin-textprimary focus:outline-none focus:ring-1 focus:ring-admin-primary">
                      <option value="jkt01">Kantor Pusat JKT-01 (Jakarta)</option>
              ...
              <div className="flex justify-end">
                <button type="submit" className="px-6 py-3 bg-admin-primary hover:bg-admin-primary-hover text-white text-sm font-bold rounded-xl shadow-md shadow-admin-primary/20 transition-colors">
                  Simpan Perubahan
                </button>
              </div>
            </form>
              ...
              <div className="bg-admin-surfacewhite border border-admin-hairline p-6 rounded-2xl">
                ...
                <form onSubmit={handleSavePassword} className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                      <label className="block text-xs font-bold text-admin-textsecondary mb-1">Kata Sandi Baru</label>
                      <input type="password" required className="w-full px-4 py-2.5 bg-admin-warmbg border border-admin-hairline rounded-xl text-sm text-admin-textprimary focus:outline-none focus:ring-1 focus:ring-admin-primary" />
                    </div>
                    <div>
                      <label className="block text-xs font-bold text-admin-textsecondary mb-1">Ulangi Sandi Baru</label>
                      <input type="password" required className="w-full px-4 py-2.5 bg-admin-warmbg border border-admin-hairline rounded-xl text-sm text-admin-textprimary focus:outline-none focus:ring-1 focus:ring-admin-primary" />
                    </div>
                  </div>
                  <div className="flex justify-end pt-2">
                    <button type="submit" className="px-6 py-2.5 bg-admin-primary hover:bg-admin-primary-hover text-white font-bold text-xs rounded-xl shadow-sm transition-all">Perbarui Sandi</button>
                  </div>
                </form>
              </div>
              ...
              <div className="bg-admin-surfacewhite border border-admin-hairline p-6 rounded-2xl flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                  <h3 className="text-lg font-bold text-admin-textprimary flex items-center gap-2 mb-1">
                    ...
                    <span className={`text-[10px] font-bold px-2 py-0.5 rounded-md font-tabular uppercase tracking-wider ${is2FAEnabled ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
                      {is2FAEnabled ? 'AKTIF' : 'NONAKTIF'}
                    </span>
                  </h3>
                  <p className="text-sm text-admin-textsecondary">Tambahkan perlindungan ekstra dengan meminta OTP saat login.</p>
                </div>
                <button onClick={toggle2FA} className="px-4 py-2 bg-admin-warmbg hover:bg-admin-hairline text-admin-textprimary font-bold text-xs rounded-xl transition-all shrink-0">
          ...
          {activeTab === 'permissions' && (
            <div className="bg-admin-surfacewhite border border-admin-hairline p-6 rounded-2xl animate-fade-in">
              <div className="mb-6">
                <h3 className="text-lg font-bold text-admin-textprimary">Matriks Otoritas Administrator</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-5 border border-admin-hairline rounded-xl bg-admin-warmbg/50 flex flex-col justify-between">
                  <div>
                    ...
                    <h5 className="font-bold text-admin-textprimary mb-1">Manajemen Pengguna</h5>
                    <p className="text-xs text-admin-textsecondary leading-relaxed mb-4">Hak penuh menulis, menonaktifkan, memverifikasi produsen tani baru, dan mengekspor CSV data peternak.</p>
                  </div>
                  <span className="inline-block text-[10px] font-bold text-admin-semgreen bg-green-50 px-2 py-1 rounded-md self-start">HAK PENUH</span>
                </div>
                ...
                <div className="p-5 border border-admin-hairline rounded-xl bg-admin-warmbg/50 flex flex-col justify-between">
                  <div>
                    ...
                    <h5 className="font-bold text-admin-textprimary mb-1">Moderasi Listing</h5>
                    <p className="text-xs text-admin-textsecondary leading-relaxed mb-4">Hak penuh memvalidasi, menyetujui, dan menolak komoditas limbah yang diunggah penjual.</p>
                  </div>
                  <span className="inline-block text-[10px] font-bold text-admin-semgreen bg-green-50 px-2 py-1 rounded-md self-start">HAK PENUH</span>
                </div>
                ...
                <div className="p-5 border border-admin-hairline rounded-xl bg-admin-warmbg/50 flex flex-col justify-between">
                  <div>
                    <div className="w-10 h-10 rounded-xl bg-admin-primary/10 text-admin-primary flex items-center justify-center mb-4">
                      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10M13 16h4l4 4V10h-8z" /></svg>
                    </div>
                    <h5 className="font-bold text-admin-textprimary mb-1">Alokasi Logistik & GIS</h5>
                    <p className="text-xs text-admin-textsecondary leading-relaxed mb-4">Menugaskan kurir penjemputan, rute terlambat, dan mengakses GPS tracker.</p>
                  </div>
                  <span className="inline-block text-[10px] font-bold text-admin-semgreen bg-green-50 px-2 py-1 rounded-md self-start">HAK PENUH</span>
                </div>
                ...
                <div className="p-5 border border-admin-hairline rounded-xl bg-[#EBE7E0]/40 flex flex-col justify-between opacity-80">
                  <div>
                    ...
                    <h5 className="font-bold text-admin-textsecondary mb-1">Konfigurasi Server Induk</h5>
                    <p className="text-xs text-admin-textsecondary leading-relaxed mb-4">Akses DB SQL, modifikasi API eksternal, konfigurasi master Node.js.</p>
                  </div>
                  <span className="inline-block text-[10px] font-bold text-admin-semred bg-red-50 px-2 py-1 rounded-md self-start uppercase tracking-wider">Hanya Baca</span>
                </div>
              </div>
            </div>
          )}
      ...
      {isSuccessModalOpen && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
          <div className="bg-admin-surfacewhite w-full max-w-sm rounded-3xl border border-admin-hairline overflow-hidden p-8 text-center space-y-4 animate-fade-in shadow-xl">
            ...
            <div>
              <h3 className="text-xl font-bold text-admin-textprimary">Berhasil Disimpan</h3>
              <p className="text-sm text-admin-textsecondary mt-2">Perubahan profil admin Anda telah berhasil diperbarui.</p>
            </div>
            <button onClick={() => setIsSuccessModalOpen(false)} className="w-full mt-6 py-3 bg-admin-primary hover:bg-admin-primary-hover text-white rounded-xl text-sm font-bold transition-colors shadow-md shadow-admin-primary/20">
              Tutup
            </button>
          </div>
        </div>

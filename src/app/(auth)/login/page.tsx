      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 md:px-16 lg:px-24 xl:px-32 relative animate-fade-in py-12">
        ...
        <form onSubmit={handleLogin} className="space-y-6 max-w-sm w-full mb-8">
          <div>
            ...
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                <svg className="w-5 h-5 text-land-muted/60" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
              </div>
              <input
                type="email"
                required
          ...
          <div>
            ...
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                <svg className="w-5 h-5 text-land-muted/60" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
              </div>
              <input
                type="password"
                required
          ...
          <div className="flex items-center">
            ...
            <label htmlFor="remember" className="ml-2 text-sm text-land-muted cursor-pointer select-none font-semibold">
              Ingat Saya
            </label>
          </div>
        ...
        <div className="max-w-sm w-full">
          ...
          <div className="grid grid-cols-3 gap-3">
            <Link href="/role" className="flex flex-col items-center justify-center gap-1.5 p-3 rounded-xl border border-land-cream bg-white hover:border-land-secondary hover:bg-land-warm/10 transition-all group">
              <svg className="w-5 h-5 text-land-secondary group-hover:scale-105 transition-transform" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 002-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
              <span className="text-[9px] font-bold text-land-ink">Peternak</span>
            </Link>
            <Link href="/role" className="flex flex-col items-center justify-center gap-1.5 p-3 rounded-xl border border-land-cream bg-white hover:border-land-clay hover:bg-land-warm/10 transition-all group">
              <svg className="w-5 h-5 text-land-clay group-hover:scale-105 transition-transform" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
              <span className="text-[9px] font-bold text-land-ink">Pembeli</span>
            </Link>
            <Link href="/role" className="flex flex-col items-center justify-center gap-1.5 p-3 rounded-xl border border-land-cream bg-white hover:border-land-ink hover:bg-land-warm/10 transition-all group">
              <svg className="w-5 h-5 text-land-ink group-hover:scale-105 transition-transform" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"></path></svg>
              <span className="text-[9px] font-bold text-land-ink">Logistik</span>
            </Link>
          </div>
        </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-land-secondary overflow-hidden">
        ...
        <div className="relative z-20 flex flex-col justify-center px-16 xl:px-24 w-full h-full text-white">
          ...
          <div className="pl-6 border-l-4 border-land-clay mb-16">
            ...
            <p className="font-bold text-land-clay font-land-heading">— AgroWaste Vision 2030</p>
          </div>

          <div className="grid grid-cols-2 gap-8 border-t border-white/15 pt-8">
            <div>
              <div className="text-3xl font-bold text-land-clay font-land-heading tracking-tight mb-1">500+</div>
              <div className="text-xs text-land-bg/70 uppercase tracking-widest font-semibold">Mitra Peternak Terpercaya</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-land-clay font-land-heading tracking-tight mb-1">12.000 Ton</div>
              <div className="text-xs text-land-bg/70 uppercase tracking-widest font-semibold">Limbah Organik Terolah</div>
            </div>
          </div>

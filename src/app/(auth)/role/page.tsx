    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-land-bg font-land-body relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl w-full mb-16 animate-fade-in" style={{ "--animation-delay": "100ms" } as React.CSSProperties}>
        ...
        <div className="bg-land-surface border border-land-cream hover:border-land-secondary hover:shadow-lg hover:shadow-land-secondary/5 rounded-2xl p-8 flex flex-col items-center text-center transition-all duration-300 group">
          ...
          <h3 className="text-lg font-bold text-land-ink font-land-heading mb-3">Penjual (Peternak)</h3>
          <p className="text-xs text-land-muted leading-relaxed mb-8 flex-1">
            Kelola limbah peternakan Anda, jual sebagai pupuk organik, dan kembangkan bisnis hijau Anda secara lestari.
          </p>
          <Link href="/register?role=penjual" className="w-full py-3 bg-land-secondary hover:bg-land-secondary/90 text-white text-sm font-bold rounded-xl transition-all shadow-sm flex items-center justify-center gap-2 min-h-[44px]">
            Pilih & Lanjutkan
        ...
        <div className="bg-land-surface border border-land-cream hover:border-land-clay hover:shadow-lg hover:shadow-land-clay/5 rounded-2xl p-8 flex flex-col items-center text-center transition-all duration-300 group">
          ...
          <h3 className="text-lg font-bold text-land-ink font-land-heading mb-3">Pembeli (Petani)</h3>
          <p className="text-xs text-land-muted leading-relaxed mb-8 flex-1">
            Cari, pesan, dan beli pupuk organik berkualitas tinggi langsung dari peternakan terpercaya pilihan Anda.
          </p>
          <Link href="/register?role=pembeli" className="w-full py-3 bg-land-clay hover:bg-land-clay-hover text-white text-sm font-bold rounded-xl transition-all shadow-sm flex items-center justify-center gap-2 min-h-[44px]">
            Pilih & Lanjutkan
            <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
          </Link>
        </div>
        ...
        <div className="bg-land-surface border border-land-cream hover:border-land-ink hover:shadow-lg hover:shadow-land-ink/5 rounded-2xl p-8 flex flex-col items-center text-center transition-all duration-300 group">
          ...
          <h3 className="text-lg font-bold text-land-ink font-land-heading mb-3">Mitra Logistik</h3>
          <p className="text-xs text-land-muted leading-relaxed mb-8 flex-1">
            Bantu pengiriman pupuk organik ke pembeli, atur rute logistik GIS, dan dapatkan penghasilan secara transparan.
          </p>
          <Link href="/register?role=logistik" className="w-full py-3 bg-land-ink hover:bg-land-ink/90 text-white text-sm font-bold rounded-xl transition-all shadow-sm flex items-center justify-center gap-2 min-h-[44px]">
            Pilih & Lanjutkan
            <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
          </Link>
        </div>
      ...
      {/* Footer Links */}
      <div className="flex flex-col items-center gap-4 text-sm font-semibold animate-fade-in" style={{ "--animation-delay": "200ms" } as React.CSSProperties}>
        <div className="text-land-muted">
          Sudah punya akun? <Link href="/login" className="text-land-clay hover:text-land-clay-hover">Masuk di sini</Link>
        </div>
        <Link href="/" className="text-land-muted hover:text-land-ink flex items-center gap-1.5 transition-colors">
